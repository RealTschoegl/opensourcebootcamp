---
layout: page
title: "Week 10 : Lesson 4 : Unit Testing"
category: lesson
---

## Review

Review from [Weeks 10 : Lesson 3 : PostgreSQL and MySQL]({{ site.baseurl}}{% post_url 2014-05-07-lesson-postgresql-mysql %}).  One (or more) pair will rehash the previous session's lesson by teaching the basic learnings to the group.  They will explain it to the others by drawing a diagram, using an analogy, telling a story or in some other way creatively communicating the idea without using code.
...
* [RailsGuides: Unit Testing your Models](http://guides.rubyonrails.org/testing.html#unit-testing-your-models)
